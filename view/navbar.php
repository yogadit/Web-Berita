        ...
        <div class="container px-2 py-1">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-center ms-auto me-4 my-3 my-lg-0">
                    <li class="nav-item"><a class="nav-link me-lg-3" href="home.php">Home</a></li>
                    <li class="nav-item">
                        <div class="btn-group" style="display: block">
                            ...
                            <div id="news" style="width: 100%; margin: auto; display: none; overflow: visible">
                                ...
                                <a class="nav-link" href="news.php?kategori=Politik">Politik</a>
                                <a class="nav-link" href="news.php?kategori=Hukum">Hukum</a>
                                <a class="nav-link" href="news.php?kategori=Peristiwa">Peristiwa</a>
                                <a class="nav-link" href="news.php?kategori=Sports">Sports</a>
                                <hr class="dropdown-divider">
                                <a class="nav-link" href="news.php">All</a>
                            </div>
                        </div>
                    </li>
                    <?php
